package com.capg.studentprofile.controller;
...
import com.capg.stdentprofile.service.StudentProfileService;
import com.capg.stdentprofile.service.StudentProfileServiceImpl;
import com.capg.studentprofile.model.Student;

public class StudentProfileController {
public static Scanner scanner;
	
	public static StudentProfileService service= new StudentProfileServiceImpl();
	...
	public static void main(String[] args) {
		...
		static void getAllStudentsByCourse() {
			...
			{
				System.out.println("No Student Found with course " + courseName);
			}
		}
